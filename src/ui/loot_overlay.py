...
class LootOverlay:
    ...
    loot_text: object = None  # your outlined text helper object
    idle_text: str = ""
    ...
    def init(self, canvas):
        ...
        # IMPORT HERE to avoid circular imports if gui_text imports ui stuff
        from ui.gui_text import create_outlined_text  # adjust if needed
    ...
    def _enter(self):
        ...
        if self.state == "idle":
            ...
            if self.on_hover_enter:
                ...
                self.loot_text.set_text("Click to open!")
    ...
    def layout(self, w: int, h: int):
        ...
        # text above the image using actual img height if available
        img_h = 280
        try:
